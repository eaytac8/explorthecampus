...
namespace CnControls
{
    ...
    public class SimpleJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
    {
        ...
        [Tooltip("The height of your screen in landscape mode")]
        public int referenceScreenHeight = 1080;

        private float ratioStick;
        private float ratioBase;
        private float ratioJoystick;
        ...
        private void Awake()
        {
            ...
            joystickTransform = gameObject.GetComponent(typeof(RectTransform)) as RectTransform;
            ...
            Vector2 stickTransformPos = _stickTransform.sizeDelta;
            Vector2 baseTransformPos = _baseTransform.sizeDelta;
            Vector2 joystickTransformPos = joystickTransform.sizeDelta;

            //Assuming landscape mode
            ratioStick = stickTransformPos.x / referenceScreenHeight;
            ratioBase = baseTransformPos.x / referenceScreenHeight;
            ratioJoystick = joystickTransformPos.x / referenceScreenHeight;
        }
        ...
        void Update()
        {
            ...
            float sizeStick = screenSize * ratioStick;
            float sizeBase = screenSize * ratioBase;
            float sizeJoystick = screenSize * ratioJoystick;

            _stickTransform.sizeDelta = new Vector2(sizeStick, sizeStick);
            _baseTransform.sizeDelta = new Vector2(sizeBase, sizeBase);
            joystickTransform.sizeDelta = new Vector2(sizeJoystick, sizeJoystick);
        }
